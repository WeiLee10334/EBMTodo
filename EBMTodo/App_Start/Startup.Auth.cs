...
namespace EBMTodo
{
    public partial class Startup
    {
        ...
        {
            ActiveDirectorySection ADSection = System.Configuration.ConfigurationManager.GetSection("ActiveDirectory") as ActiveDirectorySection;

            if (ADSection.UseActiveDirectory)
            {
